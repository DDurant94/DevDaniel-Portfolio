 ...
 * 
 * @description Hero section for About Me page with scroll-based fade effect.
...
export default function AboutHero() {
  ...
  return (
    <header id="about-hero" className="hero-section" ref={heroRef}>
      <div className="hero-copy hero-copy-visible">
        <h1>About Me</h1>
        <p>Crafting thoughtful software & immersive experiences.</p>
      </div>
    </header>
  );
}
